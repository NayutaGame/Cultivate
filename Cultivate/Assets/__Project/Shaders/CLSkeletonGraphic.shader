...
Shader "CL/SkeletonGraphic"
{
	Properties
	{
		...
		[HideInInspector] _ScribbleTex ("Scribble Texture", 2D) = "black" {}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag (VertexOutput IN) : SV_Target
			{
				...
				half4 scribbleColor = tex2D(_ScribbleTex, IN.texcoord);

				#if defined(_STRAIGHT_ALPHA_INPUT)
				texColor.rgb *= texColor.a;
				scribbleColor.rgb *= scribbleColor.a;
				#endif

				texColor.rgb = scribbleColor.rgb + texColor.rgb * (1.0 - scribbleColor.a);
				texColor.a = scribbleColor.a + texColor.a * (1.0 - scribbleColor.a);
