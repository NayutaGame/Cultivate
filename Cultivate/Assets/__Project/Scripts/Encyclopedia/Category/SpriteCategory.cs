...
public class SpriteCategory : Category<SpriteEntry>
{
    public SpriteCategory()
    {
        AddRange(new List<SpriteEntry>()
        {
            ...
            // Entities
            new("Sprite07_001", "RunIcon缺失", "Images/RunIcons/噬金甲"),
            new("Sprite07_002", "RunIcon徐福", "Images/RunIcons/徐福"),
            new("Sprite07_003", "RunIcon子非鱼", "Images/RunIcons/子非鱼"),
            new("Sprite07_004", "RunIcon子非燕", "Images/RunIcons/子非燕"),
            new("Sprite07_005", "RunIcon风雨晴", "Images/RunIcons/风雨晴"),
            new("Sprite07_006", "RunIcon彼此卿", "Images/RunIcons/彼此卿"),
            new("Sprite07_007", "RunIcon噬金甲", "Images/RunIcons/噬金甲"),
            new("Sprite07_008", "RunIcon墨蛟", "Images/RunIcons/墨蛟"),
            new("Sprite07_009", "RunIcon渊虾", "Images/RunIcons/渊虾"),
            new("Sprite07_010", "RunIcon九尾", "Images/RunIcons/九尾"),
            new("Sprite07_011", "RunIcon推山兽", "Images/RunIcons/推山兽"),
            new("Sprite07_012", "RunIcon白泽", "Images/RunIcons/白泽"),
            new("Sprite07_013", "RunIcon鲲", "Images/RunIcons/鲲"),
            new("Sprite07_014", "RunIcon毕方", "Images/RunIcons/毕方"),
            new("Sprite07_015", "RunIcon火蟾", "Images/RunIcons/火蟾"),
            new("Sprite07_016", "RunIcon麒麟", "Images/RunIcons/麒麟"),
            new("Sprite07_017", "RunIcon醉良", "Images/RunIcons/醉良"),
            new("Sprite07_018", "RunIcon童游", "Images/RunIcons/童游"),
            new("Sprite07_019", "RunIcon眠谷", "Images/RunIcons/眠谷"),
            new("Sprite07_020", "RunIcon常夏", "Images/RunIcons/常夏"),
            new("Sprite07_021", "RunIcon司方", "Images/RunIcons/司方"),
            // Run Models
            ...
            // new("Prefab0015", "RunModel九尾", "Prefabs/RunModels/九尾"),
    ...
    public SpriteEntry MissingRunIcon() => FromName("RunIcon噬金甲");
}
