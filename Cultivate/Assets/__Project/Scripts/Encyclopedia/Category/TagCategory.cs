...
public class TagCategory : Category<TagEntry>
{
    ...
    public static TagEntry Exhaust  => Encyclopedia.TagCategory.List[11];
    public static TagEntry Deplete  => Encyclopedia.TagCategory.List[12];
    public static TagEntry ZiZhi    => Encyclopedia.TagCategory.List[13];
