...
public class EntityCategory : Category<EntityEntry>
{
    public EntityCategory()
    {
        AddRange(new List<EntityEntry>()
        {
            ...
            new("Entity0012", "凌霄大圣", "Boss金系"),
            new("Entity0013", "龟仙人", "Boss水系"),
            new("Entity0014", "鹤仙人", "Boss木系"),
            new("Entity0015", "鹿仙人", "Boss火系"),
            new("Entity0016", "土行大圣", "Boss土系"),
            ...
            new("Entity0024", "教学怪物4", "神秘人", modelName: "梦乃遥"),
            new("Entity0025", "教学怪物5", "神秘人", modelName: "梦乃遥"),
            ...
            new("Entity0030", "教学怪物10", "教学怪物10", modelName: "梦乃遥"),
            new("Entity0031", "教学怪物11", "教学怪物11", modelName: "梦乃遥"),
            ...
            new("Entity0046", "多段HomeA", "多段HomeA", modelName: "彼此卿"),
            new("Entity0047", "多段AwayA", "多段AwayA", modelName: "彼此卿"),
            new("Entity0048", "多段HomeB", "多段HomeB", modelName: "彼此卿"),
            new("Entity0049", "多段AwayB", "多段AwayB", modelName: "彼此卿"),
            new("Entity0050", "多段HomeC", "多段HomeC", modelName: "彼此卿"),
            new("Entity0051", "多段AwayC", "多段AwayC", modelName: "彼此卿"),
            new("Entity0052", "多段HomeD", "多段HomeD", modelName: "彼此卿"),
            new("Entity0053", "多段AwayD", "多段AwayD", modelName: "彼此卿"),
