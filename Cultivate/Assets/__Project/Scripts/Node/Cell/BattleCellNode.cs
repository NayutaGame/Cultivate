...
[NodeWidth(200)]
[CreateNodeMenu("Cell/Battle Cell", -10, true)]
public class BattleCellNode : CellNode
{
    ...
    private InputPort<EditorEntityQuery> EntityQuery;
    ...
    protected override Cell CreateInternalCell()
    {
        ...
        EntityQuery entityQuery = global::EntityQuery.FromEditorQuery(editorQuery);
