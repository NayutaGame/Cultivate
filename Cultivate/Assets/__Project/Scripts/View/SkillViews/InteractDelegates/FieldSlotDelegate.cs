...
public class FieldSlotDelegate : InteractDelegate
{
    public void HoverAnimation(PointerEventData eventData)
    {
        ...
        PlayFollowAnimation(AddressDelegate.GetComponent<RectTransform>(), GetComponent<PivotDelegate>().HoverPivot);
    ...
    public void UnhoverAnimation(PointerEventData eventData)
    {
        ...
        PlayFollowAnimation(AddressDelegate.GetComponent<RectTransform>(), PivotDelegate.IdlePivot);
