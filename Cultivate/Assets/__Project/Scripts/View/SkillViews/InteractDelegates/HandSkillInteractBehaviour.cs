...
public class HandSkillInteractBehaviour : InteractBehaviour
{
    ...
    public void EndDrag(PointerEventData eventData)
    {
        ...
        SetPivotWithoutAnimation(CanvasManager.Instance.SkillGhost.RectTransform);
    ...
    public void Drag(PointerEventData eventData)
    {
        ...
        if (CanvasManager.Instance.SkillGhost.IsAnimating)
            return;
        CanvasManager.Instance.SkillGhost.RectTransform.position = PivotBehaviour.FollowPivot.position;
    }
}
