...
public class RoomAnnotationView : AnnotationView
{
    [SerializeField] private RoomIconView RoomIconView;
    ...
    public override Vector3 GetCriticalDisplacement(AnnotationAlignmentDetails d)
    {
        ...
        {
            return RoomIconView.GetRect().position - GetRect().position;
        }
    ...
    public override void SetAddress(Address address)
    {
        ...
        RoomIconView.SetAddress(d.Address);
    }
    ...
    public override void Refresh()
    {
        ...
        AnnotationDetails d = Get<AnnotationDetails>();
        AnnotatableRoom room = d.Address.Get<AnnotatableRoom>();
        Title.text = room.GetTitle();
        Description.text = room.GetDescription().GetHighlightedString();

        RoomIconView.Refresh();
    }
}
