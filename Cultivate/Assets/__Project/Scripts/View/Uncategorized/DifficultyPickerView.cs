...
public class DifficultyPickerView : MonoBehaviour
{
    ...
    [SerializeField] private Image DemoMask;
    [SerializeField] private Image DemoText;
    ...
    public void Refresh()
    {
        ...
        bool hasPrev = new Bound(0, profiles.Count() - 1).Contains(prevIndex);
        ...
        bool hasNext = new Bound(0, profiles.Count() - 1).Contains(nextIndex);
