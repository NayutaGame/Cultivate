    ...
    IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    ...
    public virtual void Refresh()
    {
        ...
        //     SetSkillTypeText((acquiredRunChip.Skill._entry as WaiGongEntry).SkillTypeCollection);
        //
        //     SetColorFromJingJie(acquiredRunChip.GetJingJie());
        //
        //     _image.sprite = acquiredRunChip.Skill._entry.CardFace;
        // }
        ...
        //         PowerText.text = heroChipSlot.GetPowerString();
        //         SetSkillTypeText((heroChipSlot.RunSkill._entry as WaiGongEntry).SkillTypeCollection);
        //
        //         SetColorFromJingJie(heroChipSlot.RunSkill.JingJie);
        //         _image.sprite = heroChipSlot.RunSkill._entry.CardFace;
        //     }
        // }
        // else if (RunManager.Get<SkillSlot>(GetIndexPath()) is { } enemyChipSlot)
        // {
        ...
        //         NameText.text = enemyChipSlot.Skill.GetName();
        //         SetDescriptionText(enemyChipSlot.GetDescription());
        //         PowerText.text = enemyChipSlot.GetPowerString();
        //         SetSkillTypeText((enemyChipSlot.Skill._entry as WaiGongEntry).SkillTypeCollection);
        //         SetColorFromJingJie(enemyChipSlot.Skill.JingJie);
        //         _image.sprite = enemyChipSlot.Skill._entry.CardFace;
        //     }
        // }
        // else if(RunManager.Get<RunSkill>(GetIndexPath()) is { } runChip)
        // {
        //     gameObject.SetActive(true);
        //
    ...
    public virtual void OnDrop(PointerEventData eventData)
    {
        ...
        // else if (RunManager.Get<SkillSlot>(GetIndexPath()) is { } enemyChipSlot)
        // {
        //     RunSkill fromArenaSkill = RunManager.Get<RunSkill>(drop.GetIndexPath());
        //     if (fromArenaSkill != null)
        //     {
        //         if (enemyChipSlot.TrySetSkill(fromArenaSkill)) return;
        //         return;
        //     }
        //
        //     AcquiredRunChip fromAcquired = RunManager.Get<AcquiredRunChip>(drop.GetIndexPath());
        ...
        //     if (fromHeroChipSlot != null)
        //     {
        //         if (enemyChipSlot.TrySetSkill(fromHeroChipSlot)) return;
        //         return;
        //     }
        // }
    }
