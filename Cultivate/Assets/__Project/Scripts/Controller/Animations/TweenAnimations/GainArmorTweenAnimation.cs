...
public class GainArmorTweenAnimation : Animation
{
    private Transform _baseTransform;
    private Transform _transform;

    public GainArmorTweenAnimation(Transform baseTransform, Transform transform, bool isAwait, bool induced) : base(isAwait, induced)
    {
