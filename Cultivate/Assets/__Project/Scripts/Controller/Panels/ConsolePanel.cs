...
public class ConsolePanel : Panel
{
    ...
    {
        CanvasManager.Instance.RunCanvas.GainSkillProcedure(CanvasManager.Instance.ScreenCenterInWorld(), SkillDescriptor.FromJingJie(RunManager.Instance.Environment.Map.JingJie));
    }
}
