...
public class ConsolePanel : Panel
{
    ...
    {
        CanvasManager.Instance.RunCanvas.DrawSkillProcedure(CanvasManager.Instance.ScreenCenterInWorld(), SkillEntryDescriptor.FromJingJie(RunManager.Instance.Environment.JingJie));
    }
}
