...
public class EntityCategory : Category<EntityEntry>
{
    public EntityCategory()
    {
        AddRange(new List<EntityEntry>()
        {
            ...
            new("玩家手牌11", "玩家手牌11"),
            new("玩家手牌12", "玩家手牌12"),
            new("多段HomeA", "多段HomeA", modelName: "徐福"),
            new("多段AwayA", "多段AwayA", modelName: "徐福"),
            new("多段HomeB", "多段HomeB", modelName: "徐福"),
            new("多段AwayB", "多段AwayB", modelName: "徐福"),
            new("多段HomeC", "多段HomeC", modelName: "徐福"),
            new("多段AwayC", "多段AwayC", modelName: "徐福"),
            new("多段HomeD", "多段HomeD", modelName: "徐福"),
            new("多段AwayD", "多段AwayD", modelName: "徐福"),
