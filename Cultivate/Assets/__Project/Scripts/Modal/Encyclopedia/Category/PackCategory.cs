    ...
    public PackCategory()
    {
        AddRange(new List<PackEntry>()
        {
            ...
            new(id:                  "0005",
                ...
                cardNames:           new string[] { "若竹", "回春", "小松", "清泉", "落英", "钟声", "入木三分", "梅开二度", "一叶知秋" }
                ),
            ...
            new(id:                  "0006",
                ...
                cardNames:           new string[] { "潜龙在渊", "明神", "见龙在田", "一心一剑", "飞龙在天", "回响", "亢龙有悔", "鹤回翔", "一念无量劫" }
                ),
            ...
            new(id:                  "0008",
                ...
                cardNames:           new string[] { "轰天", "明镜", "不动明王诀", "舍生", "怒瞳", "浴火", "晚霞", "观众生", "常夏" }
                ),
            ...
            new(id:                  "0012",
                ...
                cardNames:           new string[] { "缭乱", "缭乱", "流霰", "蜕变", "燎原", "停云", "常仪", "凝水", "羲和" }
                ),
        });
    }
