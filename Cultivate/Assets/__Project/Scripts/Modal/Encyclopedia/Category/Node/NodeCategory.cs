...
public class NodeCategory : Category<NodeEntry>
{
    public NodeCategory()
    {
        AddRange(new List<NodeEntry>()
        {
            ...
            new AdventureNodeEntry("山木", "山木", normal: true,
                create: runNode =>
                {
                    int trial = 0;
            ...
            new AdventureNodeEntry("赤壁赋", "赤壁赋", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("论无穷", "论无穷", normal: true,
                create: runNode =>
                {
                    ...
                    DialogPanelDescriptor B = new DialogPanelDescriptor("你痛快写了800字，时间没过5分钟，已经写完了。" +
                        ...
                        .SetReward(new DrawSkillReward("得到一张二动牌", pred: e => e.SkillTypeComposite.Contains(SkillType.ErDong), jingJie: runNode.JingJie));
                    DialogPanelDescriptor C = new DialogPanelDescriptor("考试过了一半，你只写下了一句话。又过了一半的一半，你又写下了一句话。又过了一半的一半的一半，你再写下了一句话。。。" +
                                                  ...
                                                  "\n\n交卷之后，一名考官对你的文章很有兴趣，给你留下了一些东西。")
                        .SetReward(new DrawSkillReward("得到一张消耗牌", pred: e => e.SkillTypeComposite.Contains(SkillType.XiaoHao), jingJie: runNode.JingJie));
                    DialogPanelDescriptor D = new DialogPanelDescriptor("你提笔写起来。\n\n从前有座山，山里有座庙，庙里有考试，考试来考生，考生做文章，文章道从前，" +
                                                                        "从前有座山，山里有座庙，庙里有考试，考试来考生，考生做文章，文章道从前，" +
                                                                        "从前有座山，山里有座庙。。。\n\n你的文章还没写完，考试已经结束了。" +
                                                  "\n\n交卷之后，一名考官对你的文章很有兴趣，给你留下了一些东西。")
                        .SetReward(new DrawSkillReward("得到一张自指牌", pred: e => e.SkillTypeComposite.Contains(SkillType.ZiZhi), jingJie: runNode.JingJie));
            ...
            new AdventureNodeEntry("人间世", "人间世", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("神灯精灵", "神灯精灵", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("分子打印机", "分子打印机", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("神农氏", "神农氏", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("天津四", "天津四", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("后羿", "后羿", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("天界树", "天界树", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("鬼兵", "鬼兵", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("琴仙", "琴仙", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("连抽五张", "连抽五张", normal: true,
                create: runNode =>
                {
                    ...
                    DialogPanelDescriptor C = new DialogPanelDescriptor("随着喷出一大口鲜血，你回过神来，原来自己还活着，感谢大道没把自己留在那边。\n\n得到五张牌")
                        .SetReward(new DrawSkillReward("获得一个技能", jingJie: runNode.JingJie, count: 5));
            ...
            new AdventureNodeEntry("天机阁", "天机阁", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("酿造仙岛玉液酒", "酿造仙岛玉液酒", normal: true,
                create: runNode =>
                {
                    bool mixWater = false;
            ...
            new AdventureNodeEntry("解梦师", "解梦师", normal: true,
                create: runNode =>
                {
                    WuXing? wuXing = null;
            ...
            new AdventureNodeEntry("夏虫语冰", "夏虫语冰", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("照相机", "照相机", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("丢尺子", "丢尺子", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("曹操三笑", "曹操三笑", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("仙人下棋", "仙人下棋", normal: true,
                create: runNode =>
                {
            ...
            new AdventureNodeEntry("初入蓬莱", "初入蓬莱", normal: false,
                create: runNode =>
                {
            ...
            //         runNode._map.EntityPool.TryDrawEntity(out RunEntity template, new DrawEntityDetails(runNode.JingJie, allowElite: true));
            //         BattlePanelDescriptor B = new BattlePanelDescriptor(template);
            ...
            //             {
            //                 return selectedOptionSignal.Selected == 0 ? B : C;
            //             }
            //
            //             return null;
            //         };
            ...
            //         };
            //
            //         C._receiveSignal = signal => null;
            //         D._receiveSignal = signal => null;
            //         E._receiveSignal = signal => null;
            //
            //         runNode.ChangePanel(A);
            //     }),
        });
