        ...
        AddRange(new List<RoomEntry>()
        {
            ...
            new(id:                                 "休息",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor D = new DialogPanelDescriptor(
                            titleText: "喝茶",
            ...
            new(id:                                 "仙人下棋",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor BWin = new(
                        titleText: "迷路",
                    ...
                    DialogPanelDescriptor CLose = new(
                        ...
                        options: "不知过了多久");
                    DialogPanelDescriptor CLose2 = new(
                        titleText: "迷路",
            ...
            new(id:                                 "检测仪",
                ...
                create:                             (map, room) =>
                {
                    DialogPanelDescriptor A0 = new(
                        titleText: "检测仪",
                        detailedText: "你捡到了一个不曾见过的仪器，上面有5个按钮。你决定按下其中一个试试。",
                        "金", "水", "木", "下一页");

                    DialogPanelDescriptor A1 = new(
                        titleText: "检测仪",
                        detailedText: "你捡到了一个不曾见过的仪器，上面有5个按钮。你决定按下其中一个试试。",
                        "火", "土", "上一页");
            ...
            new(id:                                 "解梦师",
                ...
                create:                             (map, room) =>
                {
                    ...
                    ArbitraryCardPickerPanelDescriptor B = new(
                        titleText: "解梦师",
            ...
            new(id:                                 "曹操三笑",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor B1win = new DialogPanelDescriptor(
                            titleText: "护送",
                            detailedText: "你打过了山贼，商人对你十分感激。\n\n金+6")
                        .SetReward(Reward.FromGold(6));
                    DialogPanelDescriptor B1lose = new(
                        titleText: "护送",
            ...
            new(id:                                 "山木",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor B1 = new(
                        titleText: "生气",
                        detailedText: "他看起来有点生气了。",
                        "朝他作鬼脸", "狠狠戳他一下");
                    DialogPanelDescriptor B2 = new(
                        titleText: "生气",
                    ...
                    DialogPanelDescriptor D = new DialogPanelDescriptor(
                        ...
                        .SetReward(Reward.FromGold(baseGoldReward));
                    DialogPanelDescriptor E = new DialogPanelDescriptor(
                            titleText: "生气",
            ...
            new(id:                                 "酿造仙岛玉液酒",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor BmixWater = new(
                        titleText: "市集",
                        detailedText: "果然有一人对商品感到有兴趣。问你卖多少钱？",
                    ...
                    DialogPanelDescriptor[] EndingTable = new DialogPanelDescriptor[]
                    {
                        ...
                        /* 0b000 */ new DialogPanelDescriptor(titleText: "市集", detailedText: "算了，我还是不买了。\n\n眼看市集就快结束了，你只好平价将酒出手了。\n\n不赚不赔"),
                        /* 0b001 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"你今天不卖给我，我就不走了。那人出高价来买你的酒，你含泪把钱收下了。\n\n获得{2 * baseGoldReward}金").SetReward(Reward.FromGold(2 * baseGoldReward)),
                        /* ob010 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"那人将钱交予你，把酒拿走了。劳动真光荣。\n\n获得{baseGoldReward}金").SetReward(Reward.FromGold(baseGoldReward)),
                        /* ob011 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"那人将钱交予你，把酒拿走了。劳动真光荣。\n\n获得{baseGoldReward}金").SetReward(Reward.FromGold(baseGoldReward)),
                        /* 0b100 */ new DialogPanelDescriptor(titleText: "市集", detailedText: "算了，我还是不买了。\n\n眼看市集就快结束了，你只好平价将酒出手了。\n\n不赚不赔"),
                        /* 0b101 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"哎，看你也不容易。那人虽然看出了你的酒兑了水，但还是有些良心，于是以正常价格买走了酒。\n\n获得{baseGoldReward}金").SetReward(Reward.FromGold(baseGoldReward)),
                        /* 0b110 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"那人将钱交予你，把酒拿走了。哇，小赚了一笔。\n\n获得{2 * baseGoldReward}金").SetReward(Reward.FromGold(2 * baseGoldReward)),
                        /* 0b111 */ new DialogPanelDescriptor(titleText: "市集", detailedText: $"你个奸商。那人抓住你，说要去官府。你只好摊也不顾了，赶紧溜了。\n\n失去{baseGoldReward}金").SetReward(Reward.FromGold(-baseGoldReward)),
                    };
            ...
            new(id:                                 "人间世",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor B1 = new(
                        ...
                        options: "时间一下过了60年");
                    DialogPanelDescriptor C1 = new(
                        titleText: "功名",
                        detailedText: "先生谬论不可再提，你看那胡人会因为我们不锻造兵器，充实军备而不来侵略我们么？",
                        options: "时间一下过了60年");

                    DialogPanelDescriptor B2 = new DialogPanelDescriptor(
                        titleText: "功名",
                        detailedText: "当年的少年已经成为了宰相。见到了你，发现你的容貌60年没有发生变化，察觉你是仙人，于是说道，感谢仙人提拔。叫人给了你收藏的宝物。\n\n得到1机关牌");
                    DialogPanelDescriptor C2 = new DialogPanelDescriptor(
                            titleText: "功名",
                    ...
                    DialogPanelDescriptor E = new DialogPanelDescriptor(
                        ...
                        .SetReward(Reward.FromGold(10));
                    DialogPanelDescriptor F = new DialogPanelDescriptor(
                        titleText: "功名",
            ...
            new(id:                                 "矛与盾",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor BPass = new DialogPanelDescriptor(
                        titleText: "矛盾",
                    ...
                    DialogPanelDescriptor CPass = new DialogPanelDescriptor(
                        titleText: "矛盾",
            ...
            new(id:                                 "鬼兵",
                ...
                create:                             (map, room) =>
                {
                    ...
                    CardPickerPanelDescriptor BPick = new CardPickerPanelDescriptor(
                        titleText: "仪式感",
            ...
            new(id:                                 "悟道",
                ...
                create:                             (map, room) =>
                {
                    ...
                    DialogPanelDescriptor A = new(
                        ...
                        options[0]._name, options[1]._name, options[2]._name);
