        ...
        AddRange(new List<NodeEntry>()
        {
            ...
            new(id:                                 "初入蓬莱",
                ...
                create:                             (map, ladder) =>
                {
                    ...
                    DialogPanelDescriptor ZhiRuRe = new("请重新尝试置入教学");
                    DialogPanelDescriptor LingQiRe = new("请重新尝试灵气教学");
                    DialogPanelDescriptor HeChengRe = new("请重新尝试合成教学");

                    ZhiRuRe[0].SetSelect(option => ZhiRuBattle);
                    LingQiRe[0].SetSelect(option => LingQiBattle);
                    HeChengRe[0].SetSelect(option => HeChengBattle);
            ...
            new(id:                                 "后羿1",
                ...
                create:                             (map, ladder) =>
                {
                    ...
                    B.SetOperation(s =>
                    {
                        if (s.Flag == 1)
                        {
                            RunManager.Instance.Environment.Map.InsertAdventure("后羿2");
                            return BPass;
                        }
            ...
            new(id:                                 "后羿2",
                ...
                create:                             (map, ladder) =>
                {
                    ...
                    B.SetOperation(s =>
                    {
                        if (s.Flag == 1)
                        {
                            RunManager.Instance.Environment.Map.InsertAdventure("后羿3");
                            return BPass;
                        }
