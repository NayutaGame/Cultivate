    ...
    public SkillCategory()
    {
        AddRange(new List<SkillEntry>()
        {
                ...
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.DID_DAMAGE, 0,
                        async (owner, closureDetails) =>
                        {
                            ...
                            await d.Src.GainBuffProcedure("灵气", 1 + initiator.Dj, induced: true);
            ...
            new(id:                         "0126",
                ...
                cast:                       async d =>
                {
                    await d.RemoveArmorProcedure(5 + 5 * d.Dj, induced: false);
                    int value = (-d.Caster.Opponent().Armor).ClampLower(0);
                    if (value > 0)
            ...
            new(id:                         "0128",
                ...
                cast:                       async d =>
                {
                    ...
                    d.CastResult.AppendCond(false);
                    await d.AttackProcedure(10 + 8 * d.Dj,
                        closures: new [] { closure });
                }),
            ...
            new(id:                         "0115",
                ...
                cast:                       async d =>
                {
                    ...
                    int gain = d.Caster.Armor / (15 - 5 * d.Dj);
                    await d.CycleProcedure(WuXing.Jin, gain: gain);
                }),
            ...
            new(id:                         "0113",
                ...
                cast:                       async d =>
                {
                    await d.AttackProcedure(6, times: 3,
                        closures: new[] { Crit });
                }),
            ...
            new(id:                         "0110",
                ...
                jingJieBound:               JingJie.LianQi2HuaShen,
                castDescription:            (j, dj, costResult, castResult) =>
                    $"施加{Fib.ToValue(4 + dj)}破甲" +
                    $"\n自身每1破甲，多1" +
                    $"\n开局：施加{Fib.ToValue(4 + dj)}破甲",
                cast:                       async d =>
                {
                    int fragile = -d.Caster.Armor.ClampUpper(0);
                    int value = Fib.ToValue(4 + d.Dj) + fragile;
                    await d.RemoveArmorProcedure(value, false);
                },
                startStageCast:             async d =>
                {
                    int value = Fib.ToValue(4 + d.Skill.Dj);
                    await d.Caster.RemoveArmorProcedure(value, false);
                }),
            ...
            new(id:                         "0108",
                ...
                cast:                       async d =>
                {
                    await d.GainBuffProcedure("灵气", 4);
                    d.Caster.SetActionPoint(2);

                    await d.GainBuffProcedure("滞气", 4 - d.Dj);
                }),
            ...
            new(id:                         "0204",
                ...
                cast:                       async d =>
                {
                    ...
                    if (d.J >= JingJie.HuaShen)
                        await d.GainBuffProcedure("玄武吐息法");
                    // await Procedure
            ...
            new(id:                         "0205",
                ...
                castDescription:            (j, dj, costResult, castResult) =>
                    $"{4 + 4 * dj}攻".ApplyAttack() +
                    $"\n未击伤：气血+{4 + 4 * dj}".ApplyCond(castResult),
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.UNDAMAGED, 0,
                        async (owner, closureDetails) =>
                        {
                            ...
                            if (owner != d.Initiator) return;
                            StageSkill initiator = d.Initiator as StageSkill;
                            await d.Src.HealProcedure(4 + 4 * initiator.Dj, induced: true);
                            d.CastResult.AppendCond(true);
                        });
                ...
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.WIL_ATTACK, 0,
                        async (owner, closureDetails) =>
                        {
                            ...
                            d.Value += mana * (3 + initiator.Dj);
                        });
                    
                    await d.AttackProcedure(14,
                        closures: new [] { closure });
                }),
            ...
            new(id:                         "0225",
                ...
                castDescription:            (j, dj, costResult, castResult) =>
                    (j < JingJie.HuaShen ? $"灵气翻倍" : $"灵气变成三倍") +
                    $"\n之后无法获得灵气",
                cast:                       async d =>
                {
                    int value = d.Caster.GetStackOfBuff("灵气");
                    value *= (d.J < JingJie.HuaShen ? 1 : 2);
                    await d.GainBuffProcedure("灵气", value);
                    await d.GainBuffProcedure("禁止灵气");
                }),
            ...
            new(id:                         "0208",
                ...
                cast:                       async d =>
                {
                    await d.GainBuffProcedure("灵气", 5 + 2 * d.Dj);
                }),
            ...
            new(id:                         "0211",
                ...
                cast:                       async d =>
                {
                    await d.CycleProcedure(WuXing.Shui, gain: 1 + d.Dj);
                    await d.GainBuffProcedure("瑞雪", induced: false);
                    await d.GainBuffProcedure("禁止二动", induced: false);
                }),
            ...
            new(id:                         "0307",
                ...
                costDescription:            CostDescription.ManaFromValue(1),
                castDescription:            (j, dj, costResult, castResult) =>
                    $"双方护甲+{6 + 4 * dj}".ApplyDefend() +
                    $"\n双方气血+{6 + 4 * dj}".ApplyHeal(),
                cast:                       async d =>
                {
                    int value = 6 + 4 * d.Dj;
                    await d.GainArmorProcedure(value, induced: false);
                ...
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.WIL_ATTACK, 0,
                        async (owner, closureDetails) =>
                        {
                            ...
                            d.Value += (5 + initiator.Dj - 1) * power;
                        });
            ...
            new(id:                         "0323",
                ...
                cast:                       async d =>
                {
                    await d.GainBuffProcedure("二重", 1 + d.Dj);
                }),
            ...
            new(id:                         "0302",
                ...
                costDescription:            CostDescription.ManaFromValue(1),
                castDescription:            (j, dj, costResult, castResult) =>
                    ($"成长{2 + dj}次后：" + ($"{(4 + 2 * dj) * (4 + 2 * dj)}攻".ApplyAttack())).ApplyStyle(castResult, "0") +
                    $"\n成长{2 + dj}次前：闪避+1".ApplyStyle(castResult, "1"),
                cast:                       async d =>
                {
                    bool cond0 = d.Cc >= 2 + d.Dj;
                    bool cond1 = !cond0;
                    ...
                    if (cond1)
                        await d.GainBuffProcedure("闪避", induced: false);
            ...
            new(id:                         "0321",
                ...
                cast:                       async d =>
                {
                    await d.HealProcedure(2 + 4 * d.Dj + d.Cc * Fib.ToValue(2 + d.Dj), induced: false);
                }),
            ...
            new(id:                         "0316",
                ...
                wuXing:                     WuXing.Mu,
                jingJieBound:               JingJie.JinDan2HuaShen,
                cost:                       CostResult.ManaFromJ(j => (j <= JingJie.JinDan ? 2 : 0)),
            ...
            new(id:                         "0318",
                ...
                skillTypeComposite:         SkillType.Defend,
                castDescription:            (j, dj, costResult, castResult) =>
                    $"{2 + dj}攻x{2 + dj}".ApplyAttack() +
                    $"\n力量/" + "闪避".ApplyDefend() + $"+{2 + dj}" +
                    $"\n遭受不堪一击".ApplyDebuff(),
                cast:                       async d =>
                {
                    int value = 2 + d.Dj;
                    await d.GainBuffProcedure("力量", value, induced: true);
                    await d.GainBuffProcedure("闪避", value, induced: true);
                    await d.AttackProcedure(value, times: value);
                    await d.GainBuffProcedure("不堪一击", induced: true);
                }),
            ...
            new(id:                         "0402",
                ...
                jingJieBound:               JingJie.LianQi2HuaShen,
                skillTypeComposite:         SkillType.Attack | SkillType.Health,
                cost:                       CostResult.HealthFromValue(4),
                costDescription:            CostDescription.HealthFromValue(4),
                castDescription:            (j, dj, costResult, castResult) =>
                    $"{8 + 4 * dj}攻".ApplyAttack() +
                    $"\n残血：多{4 + 2 * dj}".ApplyCond(castResult),
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.DID_DAMAGE, 0,
                        async (owner, closureDetails) =>
                        {
                            DamageDetails d = closureDetails as DamageDetails;
                            StageSkill s = d.Initiator as StageSkill;
                            if (owner != d.Initiator) return;
                            d.Value += 4 + 2 * s.Dj;
                            d.CastResult.AppendCond(true);
                        });
            ...
            new(id:                         "0422",
                ...
                castDescription:            (j, dj, costResult, castResult) =>
                    $"护甲+{12 + 4 * dj}".ApplyDefend() +
                    $"\n锻体+5",
                cast:                       async d =>
                {
                    await d.GainArmorProcedure(12 + 4 * d.Dj, induced: false);
            ...
            new(id:                         "0425",
                ...
                closures:                   new StageClosure[]
                {
                    new(StageClosureDict.DID_DAMAGE, -1, async (owner, closureDetails) =>
                    {
                        StageSkill s = owner as StageSkill;
                        DamageDetails d = (DamageDetails)closureDetails;

                        if (s.Owner.Opponent() != d.Tgt) return;

                        string key = "DamagedTimes";
                        s.Owner.Memory.PerformOperation(key, 0, record => record += 1);
                    }),
                },
                castDescription:            (j, dj, costResult, castResult) =>
                    $"每造成过1次伤害，" + "5攻".ApplyAttack(),
                cast:                       async d =>
                {
                    string key = "DamagedTimes";
                    int value = d.Caster.Memory.TryGetVariable(key, 0);
                    await d.AttackProcedure(value * 5);
                }),
            ...
            new(id:                         "0501",
                ...
                castDescription:            (j, dj, costResult, castResult) =>
                    ...
                    $"\n遭受{5 + 2 * dj}软弱".ApplyDebuff(),
                cast:                       async d =>
                {
                    await d.AttackProcedure(Fib.ToValue(5 + d.Dj) * 2 - 2);
                    await d.GainBuffProcedure("软弱", 5 + 2 * d.Dj);
                }),
            ...
            new(id:                         "0523",
                ...
                castDescription:            (j, dj, costResult, castResult) =>
                    $"{Fib.ToValue(4 + dj)}攻".ApplyAttack() +
                    $"\n终结：护甲+{Fib.ToValue(4 + dj)}".ApplyCond(castResult),
                cast:                       async d =>
                {
                    await d.AttackProcedure(Fib.ToValue(4 + d.Dj));
            ...
            new(id:                         "0522",
                ...
                skillTypeComposite:         SkillType.Defend,
                cost:                       async (env, entity, skill, recursive) =>
                    new ChannelCostResult(await skill.IsEnd() ? 0 : 1),
                costDescription:            CostDescription.ChannelFromValue(1),
                castDescription:            (j, dj, costResult, castResult) =>
            ...
            new(id:                         "0529",
                ...
                cast:                       async d =>
                {
                    await d.GainArmorProcedure(30, induced: false);
                }),
            ...
            new(id:                         "SKILL_DTSZ_003",
                ...
                jingJieBound:               JingJie.LianQi2HuaShen,
                skillTypeComposite:         SkillType.Defend,
                cost:                       async (env, entity, skill, recursive) => new ChannelCostResult(entity.IsLowHealth ? 0 : 1),
                costDescription:            CostDescription.ChannelFromValue(1),
                castDescription:            (j, dj, costResult, castResult) =>
                    $"护甲+{Fib.ToValue(6 + dj)}".ApplyDefend() +
                    $"\n残血：免除吟唱".ApplyCond(castResult),
                cast:                       async d =>
                {
                    await d.GainArmorProcedure(Fib.ToValue(6 + d.Dj), induced: false);
                ...
                cast:                       async d =>
                {
                    StageClosure closure = new(StageClosureDict.WIL_ATTACK, 0,
                        async (owner, closureDetails) =>
                        {
                            ...
                            if (owner != d.Initiator) return;
                            StageSkill initiator = d.Initiator as StageSkill;
                            await d.Src.GainBuffProcedure("锻体", Fib.ToValue(4 + initiator.Dj), induced: true);
            ...
            new(id:                         "SKILL_DB_003",
                ...
                cast:                       async d =>
                {
                    await d.GainBuffProcedure("力量", Fib.ToValue(d.Dj + 2), induced: false);
                }),
            ...
            new(id:                         "0602",
                ...
                cast:                       async d =>
                {
                    BuffEntry[] buffEntries = new BuffEntry[] { "锋锐", "格挡", "力量", "灼烧", "坚毅" };
            ...
            new(id:                         "SKILL_HZ_007",
                ...
                cast:                       async d =>
                {
                    ...
                    BuffEntry[] buffs = new BuffEntry[] { "锋锐", "格挡", "力量", "灼烧", "坚毅" };
                    WuXing[] wuXings = new[] { WuXing.Jin, WuXing.Shui, WuXing.Mu, WuXing.Huo, WuXing.Tu };

                    int index = buffs.MinIdx(b => -d.Caster.GetStackOfBuff(b)) ?? 0;
                    WuXing wuXing = wuXings[index].Next;

                    await d.CycleProcedure(wuXing, gain: d.J <= JingJie.YuanYing ? 0 : 2);
                }),
            ...
            new(id:                         "SKILL_HZ_009",
                ...
                {
                    BuffEntry[] buffs = new BuffEntry[] { "锋锐", "格挡", "力量", "灼烧", "坚毅" };
                    int maxStacks = buffs.Max(b => d.Caster.GetStackOfBuff(b));
                    
                    if (maxStacks > 0)
                    {
                        await d.HealProcedure(maxStacks, induced: false);
            ...
            new(id:                         "1404",
                ...
                jingJieBound:               JingJie.LianQi2HuaShen,
                skillTypeComposite:         SkillType.Health,
                cost:                       CostResult.HealthFromDj(dj => 4 + 4 * dj),
