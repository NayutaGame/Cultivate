        ...
        AddRange(new List<SkillEntry>()
        {
            ...
            new(name:                       "聚气术",
                ...
                description:                (j, dj, executeResult) =>
                    "灵气+1",
                withinPool:                 false,
                cast:           async (entity, skill, recursive) =>
                {
            ...
            new(name:                       "信风",
                ...
                withinPool:                 true,
                cast:           async (caster, skill, recursive) =>
                {
            ...
            new(name:                       "灵动",
                wuXing:                     WuXing.Jin,
                jingJieRange:               JingJie.ZhuJi2HuaShen,
                cost:              ManaCostResult.FromValue(1),
                costDescription:            null,
                skillTypeComposite:         SkillType.Attack,
                description:                (j, dj, executeResult) =>
                    $"{6 + 2 * dj}攻\n" +
            ...
            new(name:                       "诸行无常",
                wuXing:                     WuXing.Jin,
                jingJieRange:               JingJie.ZhuJi2HuaShen,
                cost:              ManaCostResult.FromValue(3),
                costDescription:            null,
            ...
            new(name:                       "敛息",
                ...
                cost:              ManaCostResult.FromValue(2),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"下{1 + dj}次造成伤害转减甲",
                cast:           async (caster, skill, recursive) =>
            ...
            new(name:                       "凝水",
                wuXing:                     WuXing.Jin,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ChannelCostResult.FromDj(dj => 2 - dj),
                costDescription:            null,
            ...
            new(name:                       "袖里乾坤",
                wuXing:                     WuXing.Jin,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ChannelCostResult.FromValue(1),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"暴击+{1 + dj}\n消耗1" +
            ...
            new(name:                       "流云",
                wuXing:                     WuXing.Jin,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 2 - 2 * dj),
                costDescription:            null,
            ...
            new(name:                       "玄冰刺",
                wuXing:                     WuXing.Shui,
                jingJieRange:               JingJie.JinDan2HuaShen,
                cost:              ManaCostResult.FromValue(4),
                costDescription:            null,
                skillTypeComposite:         SkillType.Attack,
                description:                (j, dj, executeResult) =>
                    $"{16 + 8 * dj}攻\n每造成{8 - dj}点伤害，格挡+1\n水流转",
            ...
            new(name:                       "观棋烂柯",
                wuXing:                     WuXing.Shui,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 1 - dj),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"施加1跳回合",
                cast:           async (caster, skill, recursive) =>
            ...
            new(name:                       "二重",
                wuXing:                     WuXing.Mu,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ChannelCostResult.FromDj(dj => 1 - dj),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"下{1 + dj}张牌使用两次",
                cast:           async (caster, skill, recursive) =>
            ...
            new(name:                       "一切皆苦",
                wuXing:                     WuXing.Huo,
                jingJieRange:               JingJie.ZhuJi2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 3 - dj),
                costDescription:            null,
            ...
            new(name:                       "淬体",
                wuXing:                     WuXing.Huo,
                jingJieRange:               JingJie.JinDan2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 4 - dj),
                costDescription:            null,
                skillTypeComposite:         SkillType.XiaoHao,
                description:                (j, dj, executeResult) =>
                    $"消耗\n受伤时：灼烧+1",
            ...
            new(name:                       "金钟罩",
                wuXing:                     WuXing.Tu,
                jingJieRange:               JingJie.JinDan2HuaShen,
                cost:              ChannelCostResult.FromJiaShi(jiaShi => jiaShi ? 0 : 1),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"吟唱1\n" +
                    $"架势：无需吟唱" +
            ...
            new(name:                       "骑象",
                wuXing:                     WuXing.Tu,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ChannelCostResult.FromJiaShi(jiaShi => jiaShi ? 0 : 2),
                costDescription:            null,
                skillTypeComposite:         SkillType.Attack,
                description:                (j, dj, executeResult) =>
                    $"吟唱2\n" +
            ...
            new(name:                       "金刚",
                wuXing:                     WuXing.Tu,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 3 - 2 * dj),
                costDescription:            null,
                skillTypeComposite:         SkillType.Attack,
                description:                (j, dj, executeResult) =>
                    $"1攻 每有一点护甲多1攻",
            ...
            new(name:                       "天人合一",
                wuXing:                     WuXing.Tu,
                jingJieRange:               JingJie.YuanYing2HuaShen,
                cost:              ManaCostResult.FromDj(dj => 5 - 2 * dj),
                costDescription:            null,
                skillTypeComposite:         SkillType.XiaoHao,
                description:                (j, dj, executeResult) =>
                    $"消耗\n激活所有架势",
            ...
            new(name:                       "无量劫",
                wuXing:                     null,
                jingJieRange:               JingJie.ZhuJi2HuaShen,
                cost:              ChannelCostResult.FromValue(3),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"吟唱3\n治疗{18 + dj * 6}",
                withinPool:                 false,
            ...
            new(name:                       "春雨",
                wuXing:                     WuXing.Shui,
                jingJieRange:               JingJie.ZhuJi2HuaShen,
                cost:              ChannelCostResult.FromValue(2),
                costDescription:            null,
                description:                (j, dj, executeResult) =>
                    $"双方生命+{20 + 5 * dj}",
                withinPool:                 false,
