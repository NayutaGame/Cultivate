...
public class StageClosureDict : Dictionary<int, StageClosureRow>
{
    ...
    public static readonly int WIL_GAIN_MAX_HEALTH      = 42;
    public static readonly int DID_GAIN_MAX_HEALTH      = 43;
    public static readonly int WIL_LOSE_MAX_HEALTH      = 44;
    public static readonly int DID_LOSE_MAX_HEALTH      = 45;
    public static readonly int WIL_EXHAUST              = 46;
