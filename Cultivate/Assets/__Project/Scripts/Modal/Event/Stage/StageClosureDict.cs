...
public class StageClosureDict : Dictionary<int, StageClosureRow>
{
    ...
    public static readonly int WIL_BURN                 = 36;
    public static readonly int DID_BURN                 = 37;
    ...
    public static readonly int WIL_CHANNEL              = 44;
    public static readonly int DID_CHANNEL              = 45;
    public static readonly int WIL_CHANNEL_COST         = 46;
    public static readonly int DID_CHANNEL_COST         = 47;
    public static readonly int WIL_MANA_COST            = 48;
    public static readonly int DID_MANA_COST            = 49;
    public static readonly int WIL_ARMOR_COST           = 50;
    public static readonly int DID_ARMOR_COST           = 51;
    public static readonly int WIL_HEALTH_COST          = 52;
    public static readonly int DID_HEALTH_COST          = 53;
    public static readonly int WIL_MANA_SHORTAGE        = 54;
    public static readonly int DID_MANA_SHORTAGE        = 55;
    public static readonly int WIL_ARMOR_SHORTAGE       = 56;
    public static readonly int DID_ARMOR_SHORTAGE       = 57;
    public static readonly int WIL_CYCLE                = 58;
    public static readonly int DID_CYCLE                = 59;
    public static readonly int WIL_DISPEL               = 60;
    public static readonly int DID_DISPEL               = 61;
    public static readonly int WIL_COMMIT               = 62;
    public static readonly int DID_COMMIT               = 63;
