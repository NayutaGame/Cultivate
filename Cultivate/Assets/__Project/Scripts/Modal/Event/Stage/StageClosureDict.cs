...
public class StageClosureDict : Dictionary<int, StageClosureList>
{
    ...
    public static readonly int BUFF_APPEAR              = 44;
    public static readonly int BUFF_DISAPPEAR           = 45;
    public static readonly int WIL_CHANGE_STACK         = 46;
    public static readonly int DID_CHANGE_STACK         = 47;
    public static readonly int GAIN_FORMATION           = 48;
    public static readonly int LOSE_FORMATION           = 49;
    public static readonly int WIL_CHANNEL              = 50;
    public static readonly int DID_CHANNEL              = 51;
