...
public class TreeView : XView
{
    ...
    public virtual void Sync()
    {
        ...
        _model = Get<ITreeModel>();
        if (_model == null)
            return;

        foreach (object item in _model.TraversePreOrder())
        {
            // InnerInsertItem(index, item);
        }
    ...
    // public void InsertItem(TreeIndex index)
    // {
    ...
    // }
    //
    // private void InnerInsertItem(int index, object item)
    // {
